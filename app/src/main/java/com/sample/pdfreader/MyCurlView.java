...
public class MyCurlView extends View {


    /** Our Log tag */
    private final static String TAG = "MyCurlView";
    ...
    //this is the pdf renderer page list
    private ArrayList<PdfRenderer.Page> mPdfPages;
    ...
    class FlipAnimationHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            MyCurlView.this.FlipAnimationStep();
        }
     ...
     * @param pages
     */
    public void setCurlView(ArrayList<PdfRenderer.Page> pages){
...
//        this.mPages = pages;
     ...
     * @param context
     */
    public MyCurlView(Context context) {
        super(context);
        init(context);
        ResetClipEdge();
    }
     ...
     */
    public MyCurlView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
...
//            doDynamicCurl();
    ...
    private void nextView() {
        ...
        MainActivity.loadPage(MainActivity.getCurrentPage()+1);
...
//        drawBackground(canvas, rect, paint);
     ...
     * @param pageNum
     */
    public void drawPageNum(Canvas canvas, int pageNum)
    {
